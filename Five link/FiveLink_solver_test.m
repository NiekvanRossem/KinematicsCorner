...
% contact patch
r_CP_CH = [   0.000;     Track/2;      0.000];

% wheel centre
r_WC_CH = [   0;         Track/2;    197.321];

% suspension PUPs
r_FUB   = [  25.200;     555.900;	 273.321];
r_FLB   = [   8.600;	 588.100;	 119.321];
r_FUIF  = [-135.582;	 242.737;	 224.405];
r_FUIR  = [ 124.900;	 240.922;	 189.764];
r_FLIF  = [-143.127;	 167.762;	 107.621];
r_FLIR  = [  70.665;	 153.888;	 113.366];
r_FIT   = [  60.000;	 264.008;	 182.000];
r_FOT   = [  73.800;	 535.000;	 228.921];
